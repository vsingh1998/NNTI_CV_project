...
def main(args):
    ...
    torch.save(model.state_dict(), 'task1_c100_25_t95.pth')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test-batch', default=64, type=int,
                        help='test batchsize')
    parser.add_argument('--total-iter', default=750*150, type=int,
                        help='total number of iterations to run')
    parser.add_argument('--iter-per-epoch', default=750, type=int,
    ...
    parser.add_argument("--dropout", default=0.39, type=float, 
